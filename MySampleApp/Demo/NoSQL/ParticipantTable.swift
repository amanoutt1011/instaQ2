...
class ParticipantTable: NSObject, Table {
    ...
    func tableAttributeName(dataObjectAttributeName: String) -> String {
        return Participant.JSONKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(completionHandler: (response: AWSDynamoDBObjectModel?, error: NSError?) -> Void) {
        ...
        objectMapper.load(Participant.self, hashKey: AWSIdentityManager.defaultIdentityManager().identityId!, rangeKey: nil, completionHandler: {(response: AWSDynamoDBObjectModel?, error: NSError?) -> Void in
    ...
    func scanWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        objectMapper.scan(Participant.self, expression: scanExpression, completionHandler: {(response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            dispatch_async(dispatch_get_main_queue(), {
                completionHandler(response: response, error: error)
            })
        })
    ...
    func scanWithFilterDescription() -> String {
        return "Find all items with questionID < \("demo-questionID-500000")."
    }
    ...
    func scanWithFilterWithCompletionHandler(completionHandler: (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#questionID < :questionID"
        scanExpression.expressionAttributeNames = ["#questionID": "questionID" ,]
        scanExpression.expressionAttributeValues = [":questionID": "demo-questionID-500000" ,]
    ...
    func insertSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        itemForGet._responseID = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("responseID")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: Participant = Participant()
    ...
    func removeSampleDataWithCompletionHandler(completionHandler: (errors: [NSError]?) -> Void) {
        ...
        objectMapper.query(Participant.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: NSError?) -> Void in
            if let error = error {
                dispatch_async(dispatch_get_main_queue(), {
    ...
    func updateItem(item: AWSDynamoDBObjectModel, completionHandler: (error: NSError?) -> Void) {
        ...
        let itemToUpdate: Participant = item as! Participant
        
        itemToUpdate._questionID = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("questionID")
        itemToUpdate._responseID = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("responseID")
